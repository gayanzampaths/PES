 ...
 * @author gayan
 */
public class ProductionDepartmentDefects extends JFrame{
    public ProductionDepartmentDefects( String applicationTitle , String chartTitle, ArrayList<Defect> def ) {
